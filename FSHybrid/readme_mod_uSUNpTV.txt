...
2019/12/22 からの変更点
  ...
  ・NHK BS1 と スターチャンネル2/3 が、物理チャンネル BS15/TS1 と BS15/TS2 に
    一致せずに BS15/TS0 と BS15/TS1 の間違ったチャンネルと一致する問題の修正
    (PSK復調レジスタから抜き取ったtsidの下位3ビットが物理チャンネルのストリーム
     番号と実際に一致するかどうか比較して確認するコードを別途追加して対応)
